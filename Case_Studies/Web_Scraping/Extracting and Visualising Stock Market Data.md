...
When looking at the webpage and inspecting element, we use ctrl+f to find and search for table. Doing this we find that the table we want is in the 2 position out of 12. With Python's 0 based Indexing, this means it is in index 1.
...
When looking at the macrotrends webpage and using ctrl+f when inspecting element to find the tables, we can see that it is the 2nd out of 23 tables. With Python's 0 based indexing this means it is at index 1.
