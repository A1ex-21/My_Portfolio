...
This will be used as a guide for plotting in Excel.


```python
nvidia_revenue.to_csv("NVIDIA Quarterly Revenue.csv", index=False)
```
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      <th>2026-06-03 00:00:00-04:00</th>
      <td>116.397499</td>
      <td>118.290001</td>
      <td>110.860001</td>
      <td>111.824997</td>
...
```python
intel_revenue.to_csv("Intel Quarterly Revenue.csv", index=False)
```
...
**Note:** This will be used as a guide for plotting in Excel.
